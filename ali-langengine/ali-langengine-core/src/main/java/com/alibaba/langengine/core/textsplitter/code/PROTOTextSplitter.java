...
/**
 * Attempts to split the text along PROTO-formatted headings.
 *
 * @author xiaoxuan.lp
 */
@Data
public class PROTOTextSplitter extends RecursiveCharacterTextSplitter {

    public PROTOTextSplitter() {
