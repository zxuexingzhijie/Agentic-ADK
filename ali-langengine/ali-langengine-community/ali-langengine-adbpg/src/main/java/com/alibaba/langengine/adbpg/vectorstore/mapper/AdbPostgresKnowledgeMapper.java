 ...
 */
package com.alibaba.langengine.adbpg.vectorstore.mapper;

import com.alibaba.langengine.adbpg.vectorstore.KnowledgeDO;
import org.apache.ibatis.annotations.*;

import java.util.List;

/**
 * adbpostgres知识库mapper
 *
 * @author xiaoxuan.lp
 */
@Mapper
public interface AdbPostgresKnowledgeMapper {
    ...
    @Insert("insert into knowledge(content_id, type, content, idx, row_content)" +
            "values(#{contentId}, #{type}, #{content}::real[], #{idx}, #{rowContent})")
