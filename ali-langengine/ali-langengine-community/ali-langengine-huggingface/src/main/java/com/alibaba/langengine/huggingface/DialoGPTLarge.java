 ...
 * 此任务对应于任何类似聊天机器人的结构。 模型往往具有较短的 max_length，因此在使用给定模型时请谨慎检查是否需要长期依赖。
 *
...
@Slf4j
@Data
public class DialoGPTLarge extends HuggingfaceLLM {

    /**
     * 模型名称
     * required
     */
    private String model = "microsoft/DialoGPT-large";
