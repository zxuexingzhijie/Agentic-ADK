 ...
 * 此任务读取一些文本并输出原始浮点值，这些值通常作为语义数据库/语义搜索的一部分使用。
 *
...
@Slf4j
@Data
public class SentenceTransformers extends HuggingfaceLLM {

    /**
     * 模型名称
     * required
     */
    private String model = "sentence-transformers/paraphrase-xlm-r-multilingual-v1";
