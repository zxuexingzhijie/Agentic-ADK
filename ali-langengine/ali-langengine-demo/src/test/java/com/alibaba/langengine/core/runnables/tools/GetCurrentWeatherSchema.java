...
@Data
public class GetCurrentWeatherSchema extends StructuredSchema {

    public GetCurrentWeatherSchema() {
        StructuredParameter structuredParameter = new StructuredParameter();
        structuredParameter.setName("location");
        structuredParameter.setDescription("he city and state, e.g. San Francisco, CA");
        ...
        structuredParameter.setName("unit");
        structuredParameter.setDescription("The temperature unit.");
        structuredParameter.setRequired(true);
