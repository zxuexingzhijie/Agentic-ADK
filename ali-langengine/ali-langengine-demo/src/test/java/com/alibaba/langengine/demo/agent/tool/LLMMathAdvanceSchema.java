...
@Data
public class LLMMathAdvanceSchema extends StructuredSchema {

    public LLMMathAdvanceSchema() {
        StructuredParameter structuredParameter = new StructuredParameter();
        structuredParameter.setName("formula");
        structuredParameter.setDescription("formula");
