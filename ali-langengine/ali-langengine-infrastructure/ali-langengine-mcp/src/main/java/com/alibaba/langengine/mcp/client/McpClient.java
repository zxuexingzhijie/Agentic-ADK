...
public interface McpClient {
	...
	public static class Builder {
		...
		private List<Consumer<List<Tool>>> toolsChangeConsumers = new ArrayList<>();

		private List<Consumer<List<Resource>>> resourcesChangeConsumers = new ArrayList<>();

		private List<Consumer<List<Prompt>>> promptsChangeConsumers = new ArrayList<>();

		private List<Consumer<LoggingMessageNotification>> loggingConsumers = new ArrayList<>();
		 ...
		 */
		public Builder toolsChangeConsumer(Consumer<List<Tool>> toolsChangeConsumer) {
		 ...
		 */
		public Builder resourcesChangeConsumer(Consumer<List<Resource>> resourcesChangeConsumer) {
		 ...
		 */
		public Builder promptsChangeConsumer(Consumer<List<Prompt>> promptsChangeConsumer) {
		 ...
		 * @return This builder instance for method chaining
		 */
		public Builder loggingConsumer(Consumer<LoggingMessageNotification> loggingConsumer) {
		 ...
		 * @return This builder instance for method chaining
		 */
		public Builder loggingConsumers(List<Consumer<LoggingMessageNotification>> loggingConsumers) {
