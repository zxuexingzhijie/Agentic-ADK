...
@Slf4j
@Data
public class WriterTranslateSkill extends SemanticKernelSkill {
    ...
    public WriterTranslateSkill() {
        setName("WriterSkill");
        setFunctionName("Translate");
        setDescription("Translate the input into a language of your choice");
