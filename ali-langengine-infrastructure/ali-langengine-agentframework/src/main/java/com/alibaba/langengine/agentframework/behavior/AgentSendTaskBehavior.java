...
import com.alibaba.smart.framework.engine.behavior.impl.SendTaskBehavior;
...
@ExtensionBinding(group = ExtensionConstant.ACTIVITY_BEHAVIOR, bindKey = SendTask.class, priority = 1)
public class AgentSendTaskBehavior extends SendTaskBehavior {
