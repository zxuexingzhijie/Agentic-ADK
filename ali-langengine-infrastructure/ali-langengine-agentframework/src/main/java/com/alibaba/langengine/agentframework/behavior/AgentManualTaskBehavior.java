...
import com.alibaba.smart.framework.engine.behavior.impl.ManualTaskBehavior;
...
@ExtensionBinding(group = ExtensionConstant.ACTIVITY_BEHAVIOR, bindKey = ManualTask.class, priority = 1)
public class AgentManualTaskBehavior extends ManualTaskBehavior {
