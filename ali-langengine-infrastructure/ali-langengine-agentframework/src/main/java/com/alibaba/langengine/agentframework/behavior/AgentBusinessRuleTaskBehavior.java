...
import com.alibaba.smart.framework.engine.behavior.impl.BusinessRuleTaskBehavior;
...
@Slf4j
@ExtensionBinding(group = ExtensionConstant.ACTIVITY_BEHAVIOR, bindKey = BusinessRuleTask.class, priority = 1)
public class AgentBusinessRuleTaskBehavior extends BusinessRuleTaskBehavior {
