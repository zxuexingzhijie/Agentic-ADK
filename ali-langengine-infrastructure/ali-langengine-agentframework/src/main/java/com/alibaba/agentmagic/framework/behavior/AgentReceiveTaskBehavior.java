...
import com.alibaba.smart.framework.engine.behavior.impl.ReceiveTaskBehavior;
...
@ExtensionBinding(group = ExtensionConstant.ACTIVITY_BEHAVIOR, bindKey = ReceiveTask.class, priority = 1)
public class AgentReceiveTaskBehavior extends ReceiveTaskBehavior {
