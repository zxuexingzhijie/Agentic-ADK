 ...
 */
@Data
public class LlmExecuteLog {

    private static final Logger log = LoggerFactory.getLogger(LlmExecuteLog.class);
    ...
    public String toString() {
        ...
        append(sb,"firstCost", firstCost);
        append(sb,"env", env, true);
        return sb.toString();
    }
