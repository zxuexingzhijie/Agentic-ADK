...
@Data
public class CreateAppSchema extends StructuredSchema {

    public CreateAppSchema() {
        StructuredParameter structuredParameter = new StructuredParameter();
        structuredParameter.setName("applicationName");
        structuredParameter.setDescription("应用程序名称");
        ...
        structuredParameter.setName("param");
        structuredParameter.setDescription("应用程序的参数列表");
        structuredParameter.setRequired(true);
