 ...
 **/
public class AzureChatOpenAITest {
    ...
    public void test_predict_function_call() {
        AzureChatOpenAI llm = new AzureChatOpenAI(apiBase, deploymentName, "2023-07-01-preview", apiKey);
        ...
        List<FunctionDefinition> functionDefinitions = null;
    ...
    public void test_generate_prompt() {
        AzureChatOpenAI llm = new AzureChatOpenAI(apiBase, deploymentName, apiVersion, apiKey);
        long start = System.currentTimeMillis();
    ...
    @Test
    public void testChatWithJsonOutputParser() {
        JsonOutputParser<AzureChatOpenAITest.Answer> jsonOutputParser = new JsonOutputParser<>(AzureChatOpenAITest.Answer.class);
        ...
        AzureChatOpenAITest.Answer parse = jsonOutputParser.parse(hello.getContent());
        System.out.println(parse);
        /**
         * {
    ...
    static class Answer {
        ...
        private List<AzureChatOpenAITest.Animal>  animals;
    }
    @Data
    static class Animal {
    ...
    public BaseMessage chat(String prompt) {
        AzureChatOpenAI llm = new AzureChatOpenAI(apiBase, deploymentName, "2023-12-01-preview", apiKey);
