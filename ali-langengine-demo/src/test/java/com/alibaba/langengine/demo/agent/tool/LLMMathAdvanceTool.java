...
public class LLMMathAdvanceTool extends StructuredTool {
    ...
    public ToolExecuteResult execute(String toolInput) {
        ...
        if(expression != null && expression.containsKey("formula")) {
            toolInput = (String) expression.get("formula");
        }
