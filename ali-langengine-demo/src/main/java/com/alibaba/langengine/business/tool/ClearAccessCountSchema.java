...
@Data
public class ClearAccessCountSchema extends StructuredSchema {

    public ClearAccessCountSchema() {
        StructuredParameter structuredParameter = new StructuredParameter();
        structuredParameter.setName("appkey");
        structuredParameter.setDescription("应用appkey");
