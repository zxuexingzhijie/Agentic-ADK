 ...
 * @author Sinh Le
 */
class AllowTopics implements InputScanner {
    ...
    public AllowTopics(BaseLanguageModel llmChain, PromptTemplate promptTemplate, double threshold, List<String> topics) {
        this.llm = llmChain;
    ...
    public AllowTopics(BaseLanguageModel llmChain, double threshold, String... topics) {
    ...
    public ScannerResult scan(String text, Map<String, Object> extraAttributes) {
        for (String topic : topics) {
            ...
            final Map<String, Object> output = llmChain.predict(inputs, null, extraAttributes);
            ...
            if (relevantScore <= threshold) {
                return new ScannerResult(text, false, relevantScore);
            }
        }
