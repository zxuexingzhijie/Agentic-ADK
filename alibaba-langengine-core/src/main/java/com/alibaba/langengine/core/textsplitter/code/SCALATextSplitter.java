...
/**
 * Attempts to split the text along SCALA-formatted headings.
 *
 * @author xiaoxuan.lp
 */
@Data
public class SCALATextSplitter extends RecursiveCharacterTextSplitter {

    public SCALATextSplitter() {
