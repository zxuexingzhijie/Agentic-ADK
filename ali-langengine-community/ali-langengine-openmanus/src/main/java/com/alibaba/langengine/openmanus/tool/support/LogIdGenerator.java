...
public class LogIdGenerator {
    ...
    /**
     * 生成一个uuid
     * 这里采用雪花算法的思路，用版本(2byte)+时间戳(8byte)+IP(4byte)+序列号(4byte)的方式生成一个全局大致有序的uuid
    ...
    public static void main(String[] args) {
        String u1 = LogIdGenerator.generateUniqueId();
        String u2 = LogIdGenerator.generateUniqueId();
        String u3 = LogIdGenerator.generateUniqueId();
