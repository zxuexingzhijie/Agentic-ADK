...
import com.alibaba.langengine.gemini.model.GeminiLLM;
...
public class GeminiLLMTest {

    @Test
    public void test_predict() {
        GeminiLLM llm = new GeminiLLM();
    ...
    public void test_predict_gemini_pro_vision() {
        ...
        additional.put("chat_message_contents", chatMessageContents);
