...
import com.alibaba.smart.framework.engine.behavior.impl.ScriptTaskBehavior;
...
@ExtensionBinding(group = ExtensionConstant.ACTIVITY_BEHAVIOR, bindKey = ScriptTask.class, priority = 1)
public class AgentScriptTaskBehavior extends ScriptTaskBehavior {
