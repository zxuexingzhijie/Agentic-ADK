 ...
 */
package com.alibaba.langengine.agentframework.delegation.cotexecutor.outputparser;
...
@Slf4j
@Data
public class CotSequentialPlannerOutputParser extends AgentOutputParser<AgentNextStep> {

    private Map<String, BaseTool> toolMap;

    @Override
    public AgentNextStep parse(String text) {
        log.info("CotSequentialPlannerOutputParser AgentOutputParser parse:" + text);
