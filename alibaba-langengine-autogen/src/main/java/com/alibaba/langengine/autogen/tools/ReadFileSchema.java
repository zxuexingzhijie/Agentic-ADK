...
@Data
public class ReadFileSchema extends StructuredSchema {

    public ReadFileSchema() {
        StructuredParameter structuredParameter = new StructuredParameter();
        structuredParameter.setName("filePath");
        structuredParameter.setDescription("name of file");
