...
public class SQLDatabaseChainTest {
    ...
    public void test_run() {
        ...
        SQLDatabase db = SQLDatabase.fromUri("jdbc:sqlite:/Users/xiaoxuan.lp/works/sources/xiaoxuan.lp/ali-langengine/alibaba-langengine-infrastructure/alibaba-langengine-gpt/src/test/resources/Chinook.db", "sqlite");
...
//        inputs.put("query", "What are some example tracks by Bach?");
    ...
    public void test_run_sqlite_customTableInfo() {
        ...
        SQLDatabase db = SQLDatabase.fromUri("jdbc:sqlite:/Users/xiaoxuan.lp/works/sources/xiaoxuan.lp/alibaba-langengine/langengine-docs/db/Topmisc.db", "sqlite");
